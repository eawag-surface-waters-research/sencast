...
# search address
search_address = api_endpoint + "/collections/Sentinel3/search.json?"

# download address
download_address = api_endpoint + ""


def get_download_requests(auth, start, end, sensor, resolution, wkt):
    query = "maxRecords={}&startDate={}&completionDate={}&instrument={}&productType={}&status={}&geometry={}&dataset={}"
