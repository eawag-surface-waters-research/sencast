...
report(l2product_files_s3, params_s3, 'tests/ReportS3.log')
...
report(l2product_files_s2, params_s2, 'tests/ReportS2.log')
...
report(l2product_files_l8, params_l8, 'tests/ReportL8.log')
