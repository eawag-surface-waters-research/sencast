...
if hostname in ['daniels-macbook-pro.home', 'Daniels-MacBook-Pro.local']:
    ...
    polymer_path = '/Users/Daniel/anaconda3/envs/sentinel-hindcast/lib/python3.6/site-packages/polymer-v4.10'
...
elif hostname in ['SUR-CLINB005-N', 'SUR-CLINB005-N.local']:
    os.chdir('C:\\DIAS\\')
    cwd = os.getcwd()
    wkt_dir = 'C:\\DIAS\\wkt\\'
    params_path = 'C:\\Projects\\sentinel-hindcast\\parameters\\'
    gpt_path = 'C:\\Program Files\\snap\\bin\\gpt'
    polymer_path = 'C:\\Anaconda3\\envs\\sentinel-hindcast-37\\Lib\\site-packages\\polymer\\'
    # polymer_path = 'C:\\Setup\\polymer-v4.12\\'
